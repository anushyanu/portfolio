...
class BikeRentalTest(unittest.TestCase):    
    ...
    def test_returnBike_for_invalid_rentalTime(self):
        ...
        shop = BikeRental(10)
        customer = Customer()        # let the customer not rent a bike a try to return one.
        request = customer.returnBike()
        self.assertIsNone(shop.returnBike(request))        # manually check return function with error values
    ...
    def test_returnBike_for_invalid_rentalBasis(self):
        ...
        customer.bikes = 3        # create invalid rentalbasis
    ...
    def test_returnBike_for_invalid_numOfBikes(self):
        ...
        customer.rentalTime = datetime.now()
        customer.rentalBasis = 1        # create invalid bikes
        customer.bikes = 0        
        request = customer.returnBike()
    ...
    def test_returnBike_for_valid_credentials(self):
        ...
        customer6.rentalBasis = 3 # weekly        # create valid bikes for each customer
        customer1.bikes = 1
        customer2.bikes = 5 # eligible for family discount 30%
        customer3.bikes = 2
        customer4.bikes = 8 
        customer5.bikes = 15
        customer6.bikes = 30        # create past valid rental times for each customer
        ...
        customer6.rentalTime = datetime.now() + timedelta(weeks=-12)        # make all customers return their bikes
        ...
        request6 = customer6.returnBike()        # check if all of them get correct bill
...
class CustomerTest(unittest.TestCase):
    ...
    def test_return_Bike_with_invalid_input(self):
        ...
        customer.rentalBasis = 1
        customer.bikes = 0        # create invalid rentalTime
